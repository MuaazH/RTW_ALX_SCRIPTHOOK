...
enum {
    UNIT_CATEGORY_INFANTRY = 0,
    UNIT_CATEGORY_CAVALRY,
    UNIT_CATEGORY_SIEGE,
    UNIT_CATEGORY_NON_COMBATANT,
    UNIT_CATEGORY_SHIP,
    UNIT_CATEGORY_HANDLER,
    ...
    UNIT_MOUNT_ELEPHANT,
    UNIT_MOUNT_CHARIOT,
    UNIT_MOUNT_SCORPION_CART,
    UNIT_MOUNT_UNKNOWN,

    UNIT_ANIMAL_WAR_DOGS = 0,
    UNIT_ANIMAL_PIGS,
    UNIT_ANIMAL_UNKNOWN,

    UNIT_TRAINING_UNTRAINED = 0,
    UNIT_TRAINING_TRAINED,
    UNIT_TRAINING_HIGHLY_TRAINED,
    UNIT_TRAINING_UNKNOWN,

    UNIT_MENTAL_BERSERKER = 0,
    UNIT_MENTAL_IMPETUOUS,
    UNIT_MENTAL_LOW,
    UNIT_MENTAL_NORMAL,
    UNIT_MENTAL_DISCIPLINED,
    UNIT_MENTAL_UNKNOWN,
...
struct UnitType { // size 0x20C = 524
    ...
    struct {
        ...
        unsigned short upkeepCost;
        unsigned short weaponsUpgradeCost;
        unsigned short armourUpgradeCost;
        unsigned short battlesCustom;
    } startCost;
    int unknown08C; // offset 0x8C = 140
    int unknown090;
    int unknown094;
    int unknown098;
    int unknown09C;
